...
export default function HeroSection() {
  ...
  return (
    <section id="about" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute top-6 right-6 z-50 overflow-hidden">
        <motion.nav
        ...
        >
          <a href="#" onClick={handleAboutClick} className="text-gray-300 hover:text-green-500 cursor-pointer transition-colors">About</a>
          <a href="#work" className="text-gray-300 hover:text-green-500 cursor-pointer transition-colors">Work</a>
          <a href="#projects" className="text-gray-300 hover:text-green-500 cursor-pointer transition-colors">Projects</a>
          <a href="#contact" className="text-gray-300 hover:text-green-500 cursor-pointer transition-colors">Contact</a>
        </motion.nav>
      </div>
        ...
        >
          ...
          <div className="font-mono">
            ...
            <div className="flex flex-wrap gap-2 mt-2 mb-4">
              ...
              <span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">N8N</span>

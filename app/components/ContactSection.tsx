        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="font-mono">
              ...
              <motion.a
                href="mailto:alitsayyed@gmail.com"
              ...
              >
                alitsayyed@gmail.com
              </motion.a>
              <p className="text-green-500 mt-8 mb-2">$ cat resume.pdf</p>
              <motion.a
                href="/Ali-Taabesh_Sayyed_SWE_Resume_Sept_16th_2025.pdf"
                target="_blank"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">@alitsayyed</p>
                  </div>
                </motion.a>
                <motion.a
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Ali-Taabesh Sayyed</p>
                  </div>
                </motion.a>
                {/* <motion.a */}
                {/*   href="#" */}
